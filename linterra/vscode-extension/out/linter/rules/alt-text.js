    ...
    check: (code) => {
        ...
        try {
            ...
            (0, traverse_1.default)(ast, {
                JSXElement(path) {
                    ...
                    if (openingElement.name.type === 'JSXIdentifier' &&
                        ...
                        const altAttribute = openingElement.attributes.find((attr) => attr.type === 'JSXAttribute' &&
                        ...
                        if (!altAttribute) {
                            ...
                            else if (altValue?.type === 'StringLiteral' &&
                                altValue.value === '') {
                            ...
                            else if (altValue?.type === 'JSXExpressionContainer' &&
            ...
            if (process.env.NODE_ENV === 'development') {
                console.warn(`altTextRule: Could not parse code - ${error instanceof Error ? error.message : String(error)}`);
            }
            return [];
        }
        return violations;
