    ...
    check: (code) => {
        ...
        try {
            ...
            if (process.env.NODE_ENV === 'development') {
                console.warn(`contrastRule: Could not parse code - ${error instanceof Error ? error.message : String(error)}`);
            }
            return [];
        }
        return violations;
